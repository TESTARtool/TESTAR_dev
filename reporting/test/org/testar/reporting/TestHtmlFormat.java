...
public class TestHtmlFormat {
    ...
    public void setUp() throws IOException {
        ...
        String testFile = tempFolder.getRoot() + File.separator + TEST_ORIGINAL_DIRECTORY
    ...
    public void testFileCreationAndWrite() {
        String testFile = tempFolder.getRoot() + File.separator + TEST_ORIGINAL_DIRECTORY
                + File.separator + TEST_FILE_NAME + ".html";
    ...
    public void testRenameFile() {
        ...
        String renamedFile = tempFolder.getRoot() + File.separator + TEST_ORIGINAL_DIRECTORY
                + File.separator + TEST_RENAME_FILE + ".html";
        assertTrue(new File(renamedFile).exists());
        String oldTestFile = tempFolder.getRoot() + File.separator + TEST_ORIGINAL_DIRECTORY
                + File.separator + TEST_FILE_NAME + ".html";
    ...
    public void testMoveFile() throws IOException {
        assertTrue(htmlReporter.getFile().getPath()
                .endsWith(TEST_ORIGINAL_DIRECTORY + File.separator + TEST_FILE_NAME + ".html"));
        ...
        assertTrue(htmlReporter.getFile().getPath()
                .endsWith(TEST_MOVED_DIRECTORY + File.separator + TEST_FILE_NAME + ".html"));

        String movedFile = tempFolder.getRoot() + File.separator + TEST_MOVED_DIRECTORY
                + File.separator + TEST_FILE_NAME + ".html";
    ...
    public void testCopyFile() throws IOException {
        ...
        String copyFile = tempFolder.getRoot() + File.separator + TEST_COPY_DIRECTORY
                + File.separator + TEST_COPY_FILE + ".html";
        htmlReporter.duplicateFile(copyFile);

        assertTrue(htmlReporter.getFile().getPath()
                .endsWith(TEST_ORIGINAL_DIRECTORY + File.separator + TEST_FILE_NAME + ".html"));

        String copiedFile = tempFolder.getRoot() + File.separator + TEST_COPY_DIRECTORY
                + File.separator + TEST_COPY_FILE + ".html";
