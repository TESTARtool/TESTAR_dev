...
public class NativeLinker {
    ...
    public static Role getNativeRole(String roleName) {
        ...
        while (role == null && it.hasNext()) {
            ...
            if (currentRole.name().equals(roleName)) {
                return currentRole;
            }
        }
    ...
    public static Collection<Role> getNativeRoles(String... roleNames) {
        Collection<Role> roles = new ArrayList<>(roleNames.length);
    ...
    public static boolean getNativeBooleanProperty(Widget widget, String booleanPropertyName)
