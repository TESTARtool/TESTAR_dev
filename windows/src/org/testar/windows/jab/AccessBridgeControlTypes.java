...
package org.testar.windows.jab;
...
public class AccessBridgeControlTypes {
     ...
     */
    public static final String ACCESSIBLE_ALERT = "alert";
     ...
     * see ACCESSIBLE_DIALOG
     */
    public static final String ACCESSIBLE_WINDOW = "window";
     ...
     * see ACCESSIBLE_WINDOW
     */
    public static final String ACCESSIBLE_DIALOG = "dialog";

    /**
     * A specialized dialog that lets the user choose a color.
     */
    public static final String ACCESSIBLE_COLOR_CHOOSER = "color chooser";
     ...
     */
    public static final String ACCESSIBLE_DIRECTORY_PANE = "directory pane";
     ...
     */
    public static final String ACCESSIBLE_FILLER = "filler";

    /**
     * A hypertext anchor
     */
    public static final String ACCESSIBLE_HYPERLINK = "hyperlink";
     ...
     * see ACCESSIBLE_LAYERED_PANE
     */
    public static final String ACCESSIBLE_ROOT_PANE = "root pane";
     ...
     * see ACCESSIBLE_ROOT_PANE
     */
    public static final String ACCESSIBLE_LAYERED_PANE = "layered pane";
     ...
     */
    public static final String ACCESSIBLE_LIST = "list";
     ...
     * see ACCESSIBLE_LIST
     */
    public static final String ACCESSIBLE_LIST_ITEM = "list item";
     ...
     * see ACCESSIBLE_POPUP_MENU
     */
    public static final String ACCESSIBLE_MENU_ITEM = "menu item";
     ...
     */
    public static final String ACCESSIBLE_PAGE_TAB_LIST = "page tab list";
     ...
     */
    public static final String ACCESSIBLE_PAGE_TAB = "page tab";

    /**
     * A generic container that is often used to group objects.
     */
    public static final String ACCESSIBLE_PANEL = "panel";
     ...
     * see ACCESSIBLE_RADIO_BUTTON
     */
    public static final String ACCESSIBLE_PUSH_BUTTON = "push button";
     ...
     * see ACCESSIBLE_RADIO_BUTTON
     */
    public static final String ACCESSIBLE_CHECK_BOX = "check box";
     ...
     * see ACCESSIBLE_CHECK_BOX
     */
    public static final String ACCESSIBLE_RADIO_BUTTON = "radio button";

    /**
     * The header for a row of data.
     */
    public static final String ACCESSIBLE_ROW_HEADER = "row header";
     ...
     * see ACCESSIBLE_SCROLL_PANE
     */
    public static final String ACCESSIBLE_VIEWPORT = "viewport";
     ...
     */
    public static final String ACCESSIBLE_SPLIT_PANE = "split pane";

    /**
     * An object used to present information in terms of rows and columns.
     * An example might include a spreadsheet application.
     */
    public static final String ACCESSIBLE_TABLE = "table";
     ...
     */
    public static final String ACCESSIBLE_TEXT = "text";
     ...
     */
    public static final String ACCESSIBLE_TREE = "tree";
     ...
     */
    public static final String ACCESSIBLE_AWT_COMPONENT = "awt component";
     ...
     * see ACCESSIBLE_UNKNOWN
     */
    public static final String ACCESSIBLE_SWING_COMPONENT = "swing component";
     ...
     * see ACCESSIBLE_SWING_COMPONENT
     */
    public static final String ACCESSIBLE_UNKNOWN = "unknown";

    /**
     * A STATUS_BAR is an simple component that can contain
     * multiple labels of status information to the user.
     */
    public static final String ACCESSIBLE_STATUS_BAR = "status bar";

    /**
     * A DATE_EDITOR is a component that allows users to edit
     * java.util.Date and java.util.Time objects
     */
    public static final String ACCESSIBLE_DATE_EDITOR = "date editor";

    /**
     * A SPIN_BOX is a simple spinner component and its main use
     * is for simple numbers.
     */
    public static final String ACCESSIBLE_SPIN_BOX = "spinbox";

    /**
     * A FONT_CHOOSER is a component that lets the user pick various
     * attributes for fonts.
     */
    public static final String ACCESSIBLE_FONT_CHOOSER = "font chooser";

    /**
     * A GROUP_BOX is a simple container that contains a border
     * around it and contains components inside it.
     */
    public static final String ACCESSIBLE_GROUP_BOX = "group box";

    /**
     * A text header
     */
    public static final String ACCESSIBLE_HEADER = "header";

    /**
     * A text footer
     */
    public static final String ACCESSIBLE_FOOTER = "footer";

    /**
     * A text paragraph
     */
    public static final String ACCESSIBLE_PARAGRAPH = "paragraph";

    /**
     * A ruler is an object used to measure distance
     */
    public static final String ACCESSIBLE_RULER = "ruler";
