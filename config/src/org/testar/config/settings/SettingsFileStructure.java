...
public class SettingsFileStructure {
    ...
    public static String getTestSettingsStructure() {
        ...
        String mainString = String.join(System.getProperty("line.separator")
                ...
                , "#"
                , "# Enable the variable Java Access Bridge in TESTAR as true"
                , "#################################################################"
                , ""
                , ConfigTags.JavaAccessBridge.name() + " = "
                , ""
                , "#################################################################"
                , "# Sequences"
                , "#"
                ...
                , ""
                , "#################################################################"
                , "# Ignore reporting duplicated verdicts for this protocol"
                , "#################################################################"
                , ""
                , ConfigTags.IgnoreDuplicatedVerdicts.name() + " = "
                , ""
                , "#################################################################"
                ...
                , "#################################################################"
                , ""
                , ConfigTags.ProcessListener.name() + " = "
                , ConfigTags.SuspiciousProcessOutput.name() + " = "
                , ""
                , "#################################################################"
                , "# Process Logs"
                , "#"
                , "# Required ProcessListener"
                , "# (Only available for desktop applications through COMMAND_LINE)"
                , "#"
                ...
                , ""
                , "#################################################################"
                , "# Agent CLI configuration settings"
                , "#################################################################"
                , ""
                , ConfigTags.CliStateProjectionMode.name() + " = "
                , ConfigTags.AgentCLIApiKeyEnvVar.name() + " = "
                , ConfigTags.AgentCLIBaseUrl.name() + " = "
                , ConfigTags.AgentCLIModel.name() + " = "
                , ConfigTags.AgentCLIReasoningEffort.name() + " = "
                , ConfigTags.AgentCLISandboxMode.name() + " = "
                , ConfigTags.AgentCLIApprovalPolicy.name() + " = "
                , ConfigTags.AgentCLIAllowNetworkAccess.name() + " = "
                , ConfigTags.AgentCLISkipGitRepoCheck.name() + " = "
                , ConfigTags.AgentCLIPromptTitle.name() + " = "
                , ConfigTags.AgentCLIPromptText.name() + " = "
                , ""
                , "#################################################################"
                , "# LLM agents settings"
                , "#"
