// Verifies WS-UX-RUNTIME-EXECUTION-001: runtime start controls only enable for valid idle workspace state.
import test from "node:test";
import assert from "node:assert/strict";
import { canStartRuntimeMode } from "../../src/models/runtimeModeControls.js";
