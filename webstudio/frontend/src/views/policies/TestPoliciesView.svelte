<script>
    // Implements WS-UX-POLICIES-001: policies.properties editor and Java policy activation/source panels.
    import { contentChanged } from "../../models/editorDirtyState.js";
    import { editorModalCanClose } from "../../models/editorModalState.js";
    import { policySourceModalVisible } from "../../models/policyEditorState.js";
