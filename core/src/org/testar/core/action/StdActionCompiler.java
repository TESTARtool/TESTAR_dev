...
import org.testar.core.alayer.Abstractor;
...
public class StdActionCompiler {
    ...
    public Action leftTripleClickAt(Position position) {
        Assert.notNull(position);
        return new CompoundAction.Builder().add(new MouseMove(position), 1)
                .add(LMouseDown, 0).add(LMouseUp, 0).add(LMouseDown, 0)
                .add(LMouseUp, 0).add(LMouseDown, 0).add(LMouseUp, 0).build();
    }
    ...
    public Action dropDownAt(Position position) {
        ...
        return new CompoundAction.Builder().add(new MouseMove(position), 1)
                .add(LMouseDown, 0).add(LMouseUp, 0).add(NOP, 0.2)
                .add(new KeyDown(KBKeys.VK_RIGHT), 0).build();
    }
    ...
    public Action clickAndReplaceText(final Position position, final String text) {
        ...
        builder.add(new KeyDown(KBKeys.VK_CONTROL), 0.1).add(new KeyDown(KBKeys.VK_A), 0.1)
                .add(new KeyUp(KBKeys.VK_A), 0.1).add(new KeyUp(KBKeys.VK_CONTROL), 0.1);
        /*
