...
public class StaticAnalysisResolverTest {
    ...
    private List<MethodCoverage> expectedCoverage() {
        return List.of(
                ...
                new MethodCoverage("com.example.OrderManager", "<init>", 5, 10, 0),
                new MethodCoverage("com.example.OrderManager", "submitOrder", 20, 5, 5),


                new MethodCoverage("com.example.OrderManager.OrderFactoryImpl", "createOrder", 4, 15, 5),
    ...
    private List<JavaUnit> expectedJavaUnits() {
        return List.of(
                ...
                new JavaUnit("com.example.OrderManager",
                             ...
                             List.of(
                                     new MethodDeclaration("<init>", List.of(), 4, 14),
                                     new MethodDeclaration("submitOrder", List.of("List<OrderLine>", "BigDecimal"), 19, 30)
                             )),

                new JavaUnit("com.example.OrderManager.OrderFactoryImpl",
                             "C:\\Users\\Kacper\\Documents\\Marviq\\TESTAR_dev_clean\\testar\\test_resources\\javaparser\\src\\com\\example\\OrderManager.java",
                             List.of(
                                     new MethodDeclaration("createOrder", List.of("List<OrderLine>", "BigDecimal"), 3, 29)
                             )),
