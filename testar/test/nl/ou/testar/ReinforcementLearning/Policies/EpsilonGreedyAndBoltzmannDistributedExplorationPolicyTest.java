...
public class EpsilonGreedyAndBoltzmannDistributedExplorationPolicyTest {
    ...
    @Spy private final EpsilonGreedyAndBoltzmannDistributedExplorationPolicy policy = new EpsilonGreedyAndBoltzmannDistributedExplorationPolicy (new GreedyPolicy(0.0f, RLTags.SarsaValue),
