...
import static org.testar.monkey.alayer.Tags.Path;
import static org.testar.monkey.alayer.Tags.Role;
import static org.testar.monkey.alayer.Tags.Shape;
...
public class ExpectedTextExtractorBase extends Thread implements TextExtractorInterface {
    ...
    private org.testar.monkey.alayer.State _state = null;
    ...
    @Override
    public void ExtractExpectedText(org.testar.monkey.alayer.State state, @Nullable Widget widget, ExpectedTextCallback callback) {
