...
public class ScriptlessWindowsActionExecutionService implements ActionExecutionService {

    private final ActionExecutionService delegate;

    public ScriptlessWindowsActionExecutionService(ActionExecutionService delegate) {
