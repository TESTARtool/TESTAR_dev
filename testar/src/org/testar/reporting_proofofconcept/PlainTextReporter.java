...
public class PlainTextReporter extends BaseReporter
{
    
    protected PlainTextReporter(String filePath)
    {
        super(new File(filePath.endsWith(".txt") ? filePath : filePath + ".txt"));
    }
