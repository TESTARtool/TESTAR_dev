...
public class SettingsDialog extends javax.swing.JFrame {
	...
	private void switchSettings(String sutSettings){
		...
		saveCurrentSettings();
		new File(Main.getResourcesSettings() + previousSSE).renameTo(new File(Main.getResourcesSettings() + sse));
    	try {
			settingsFile = Main.getResourcesSettings() + sutSettings + "/" + Main.SETTINGS_FILE;
			System.out.println("SettingDialog "+settingsFile);
	...
	private void initComponents() throws IOException {
		...
		String[] sutSettings = new File("./resources/settings/").list(new FilenameFilter() {
			@Override
