...
public class Temporalpanel {
    ...
    private void $$$setupUI$$$() {
        ...
        mainTemporalPanel.setLayout(new FormLayout("right:296px:grow,left:11dlu:noGrow,left:128px:noGrow,fill:max(d;4px):noGrow,left:4dlu:noGrow,fill:max(d;4px):noGrow,left:4dlu:noGrow,fill:195px:noGrow,fill:8px:noGrow,right:max(p;42px):noGrow,left:4dlu:noGrow,fill:max(d;4px):noGrow", "fill:401px:noGrow"));
        mainTemporalPanel.setEnabled(true);
        mainTemporalPanel.setMinimumSize(new Dimension(621, 370));
        mainTemporalPanel.setPreferredSize(new Dimension(621, 370));
        ...
        containerTab.setMinimumSize(new Dimension(617, 380));
        containerTab.setPreferredSize(new Dimension(617, 380));
        containerTab.setRequestFocusEnabled(true);
        containerTab.setVisible(true);
        CellConstraints cc = new CellConstraints();
        mainTemporalPanel.add(containerTab, cc.xyw(1, 1, 12));
        ...
        minerPanel.setLayout(new FormLayout("left:132px:noGrow,left:25px:noGrow,left:8dlu:noGrow,right:73px:noGrow,left:82px:noGrow,left:57px:noGrow,left:24px:noGrow,left:4dlu:noGrow,fill:25px:noGrow,left:4dlu:noGrow,fill:max(d;4px):noGrow,left:6dlu:noGrow,left:4dlu:noGrow,left:26px:noGrow,left:32dlu:noGrow,left:26dlu:noGrow", "center:max(d;4px):noGrow,top:4dlu:noGrow,center:28px:noGrow,top:4dlu:noGrow,center:28px:noGrow,top:5dlu:noGrow,center:max(d;4px):noGrow,center:41px:noGrow,top:4dlu:noGrow,center:max(d;4px):noGrow,center:4dlu:noGrow,center:max(d;4px):noGrow,top:4dlu:noGrow,center:p:noGrow,top:9dlu:noGrow,top:d:noGrow,center:max(d;4px):noGrow"));
        minerPanel.setMinimumSize(new Dimension(601, 400));
        minerPanel.setPreferredSize(new Dimension(601, 400));
        minerPanel.setRequestFocusEnabled(true);
        ...
        oracleFile.setToolTipText("<html>\nPoints to a .CSV file that contains the Formulas/Oracles to be checked.\n</html>");
        minerPanel.add(oracleFile, cc.xyw(2, 14, 5, CellConstraints.FILL, CellConstraints.DEFAULT));
        patternFile = new JTextField();
        patternFile.setText("");
        patternFile.setToolTipText("<html>\nPoints to .CSV file that contains the Patterns that will be instantiated to Oracles.\n</html>");
        ...
        enableTemporalOfflineOraclesCheckBox.setToolTipText("<html>Temporal oracles are automatically evaluated after a TESTAR test-run.<BR>\nProtocol (JAVA) modification might apply</html>");
        ...
        minerPanel.add(CounterExamples, cc.xyw(3, 3, 4, CellConstraints.LEFT, CellConstraints.DEFAULT));
        enforceAbstractionEquality = new JCheckBox();
        enforceAbstractionEquality.setSelected(true);
        enforceAbstractionEquality.setText("Abstraction equality");
        ...
        minerPanel.add(label11, cc.xy(1, 16, CellConstraints.RIGHT, CellConstraints.DEFAULT));
        ...
        minerPanel.add(sourceIsDb, cc.xyw(7, 5, 8, CellConstraints.LEFT, CellConstraints.DEFAULT));
        ...
        minerPanel.add(graphMLBtn, cc.xy(5, 7, CellConstraints.LEFT, CellConstraints.DEFAULT));
        sampleOracleBtn = new JButton();
        sampleOracleBtn.setPreferredSize(new Dimension(110, 30));
        sampleOracleBtn.setText("Examples");
        sampleOracleBtn.setToolTipText("<html>Generate files: <BR>\n1. sample Proposition Manager<BR>\n2. sample Oracle,<BR>\n3. sample Pattern,<BR>\n4. sample constraint.<BR>\n</html>");
        sampleOracleBtn.putClientProperty("html.disable", Boolean.FALSE);
        minerPanel.add(sampleOracleBtn, cc.xyw(2, 7, 2, CellConstraints.LEFT, CellConstraints.CENTER));
        final JLabel label12 = new JLabel();
        label12.setText("Generate:");
        minerPanel.add(label12, cc.xy(1, 7, CellConstraints.RIGHT, CellConstraints.DEFAULT));
        selectFilePropositionManager = new JButton();
        selectFilePropositionManager.setText("...");
        minerPanel.add(selectFilePropositionManager, cc.xyw(7, 8, 2));
        selectFilePatternConstraints = new JButton();
        selectFilePatternConstraints.setText("...");
        minerPanel.add(selectFilePatternConstraints, cc.xyw(7, 10, 2));
        selectFilePatterns = new JButton();
        selectFilePatterns.setText("...");
        minerPanel.add(selectFilePatterns, cc.xyw(7, 12, 2));
        selectFileOracles = new JButton();
        selectFileOracles.setText("...");
        minerPanel.add(selectFileOracles, cc.xyw(7, 14, 2));
        ...
        tacticComboBox.setMaximumSize(new Dimension(70, 38));
        tacticComboBox.setMinimumSize(new Dimension(70, 30));
        ...
        tacticComboBox.setPreferredSize(new Dimension(70, 30));
        ...
        minerPanel.add(tacticComboBox, cc.xyw(15, 12, 2, CellConstraints.LEFT, CellConstraints.DEFAULT));
        selectFileModel = new JButton();
        selectFileModel.setEnabled(false);
        selectFileModel.setText("...");
        minerPanel.add(selectFileModel, cc.xyw(7, 16, 2));
        ...
        minerPanel.add(verboseCheckBox, cc.xyw(7, 3, 8, CellConstraints.LEFT, CellConstraints.DEFAULT));
        zipOutputCheckBox = new JCheckBox();
        zipOutputCheckBox.setSelected(false);
        zipOutputCheckBox.setText("Zip Output");
        zipOutputCheckBox.setToolTipText("<html>\nWhen checked: Zips large files to conserve diskspace<BR>\nApplies only to Model JSON files and GraphML.XML<BR>\nUse-case: Models, but certainly GraphML.XML files can become very large<BR>\n</html>");
        minerPanel.add(zipOutputCheckBox, cc.xyw(15, 5, 2, CellConstraints.LEFT, CellConstraints.DEFAULT));
        testDbButton = new JButton();
        testDbButton.setMinimumSize(new Dimension(90, 38));
        testDbButton.setPreferredSize(new Dimension(90, 38));
        testDbButton.setText("Show DB ");
        testDbButton.setToolTipText("Exports the inventory of models in the Graph database to a file.");
        minerPanel.add(testDbButton, cc.xyw(15, 3, 2, CellConstraints.LEFT, CellConstraints.DEFAULT));
    ...
    private void testOracleSamples(ActionEvent evt) {
        ...
        tocoll.add(to);
        CSVHandler.save(tocoll, outputDir + "temporalOracleExample.csv");

        TemporalPattern pat = TemporalPattern.getSamplePattern();
        List<TemporalPattern> patcoll = new ArrayList<>();
        patcoll.add(pat);
        CSVHandler.save(patcoll, outputDir + "temporalPatternExample.csv");

        List<TemporalPatternConstraint> patconstraintcoll = TemporalPatternConstraint.getSampleConstraints();
        CSVHandler.save(patconstraintcoll, outputDir + "temporalPatternConstraintExample.csv");
        tcontrol.setDefaultPropositionManager();
        tcontrol.savePropositionManager("PropositionManagerExample.json");
    }
