...
//    }
    ...
    public Map<String,Object> peekNode(String inFile) { // actually need proper error  handling... throws Exception {
        return peekNode(inFile,"",true,"");
    }
    public Map<String,Object> peekNode(String inFile,String nodeStartsWith) { // actually need proper error  handling... throws Exception {
        return peekNode(inFile,nodeStartsWith,true,"");
    }
    public Map<String,Object> peekNode(String inFile,Boolean primitvesOnly) { // actually need proper error  handling... throws Exception {
        return peekNode(inFile,"",primitvesOnly,"");
    }
    public Map<String,Object> peekNode(String inFile,String nodeStartsWith,Boolean primitvesOnly) { // actually need proper error  handling... throws Exception {
 ...
 //   }
    private Map<String,Object> peekNode(String inFile, String nodeStartsWith, Boolean primitvesOnly, String subnode){ // actually need proper error  handling... throws Exception {
