...
public class SnNumberOfUnexecutedLeftClicks extends StrategyNodeNumber {
    ...
    public SnNumberOfUnexecutedLeftClicks(final ArrayList<StrategyNode> children) {
        super(children);
    }

    @Override
    public int getValue(final StrategyGuiState state) {
        return state.getNumberOfActions(ActionRoles.LeftClickAt, ActionExecutionStatus.UNEX);
    }
