...
public class EpsilonGreedyDoubleQPolicy implements Policy {
    ...
    private final GreedyDoubleQPolicy<?> greedyPolicy;

    public EpsilonGreedyDoubleQPolicy(final GreedyDoubleQPolicy<?> greedyPolicy, final float epsilon) {
