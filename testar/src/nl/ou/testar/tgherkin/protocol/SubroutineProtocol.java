...
public abstract class SubroutineProtocol extends ClickFilterLayerProtocol implements ProtocolProxy {
    ...
    /**
     * Text of address- and search bar in Dutch version (see ENUM Browser)
     */
    ...
    /**
     * String with name of file with source code of the subroutine document
     */
    private String sourceFile;

    /**
     * String with contents of source code of the subroutine document
     */
    ...
    /*
     * Reference to folder of the actual protocol Class
     ...
     * Contents of file will be stored in subroutineData HashMap
    ...
    /** Define set of actions to be taken when switching from subroutine to TESTAR.
     * @param state the SUT's current state
    ...
    */
	 ...
	 * @param state the SUT's current state
	 * @return Set<Action> the actions to be taken
	 */
    ...
    protected Set<Action> deriveActions(SUT system, State state) throws ActionBuildException {
        ...
        if (subroutine == null) {
            ...
            if (!moreSubroutineActions(state)) {
                ...
                System.out.println("Continue subroutine");
                if (subroutineMode()) {
    ...
    */
     ...
     * In this case the first action will be to finish the subroutine and
     * in a next step the sequence will be finished
    ...
    public Integer getActualIndexSD() {
        return actualIndexSD;
    }
    ...
    public void setActualIndexSD(Integer actualIndexSD) {
        this.actualIndexSD = actualIndexSD;
    }
}