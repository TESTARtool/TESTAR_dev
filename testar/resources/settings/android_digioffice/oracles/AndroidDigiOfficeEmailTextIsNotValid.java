...
public class AndroidDigiOfficeEmailTextIsNotValid extends AbstractAndroidDigiOfficeOracle {
    ...
    public AndroidDigiOfficeEmailTextIsNotValid() {
        super("AndroidDigiOfficeEmailTextIsNotValid");
    }

    private boolean isEmailWidget(Widget widget) {
        String resourceId = widget.get(AndroidTags.AndroidResourceId, "");
        return EMAIL_WIDGET_ID_PATTERN.matcher(resourceId).matches();
    }
