...
public class AndroidDigiOfficeDocumentUploadInfoIsNotEmptyNotNA extends AbstractAndroidDigiOfficeOracle {

    private static final java.util.regex.Pattern DOCUMENT_UPLOAD_INFO_WIDGET_ID_PATTERN = java.util.regex.Pattern
            .compile(".*dms-documentUpload-info-(assigned-to|uploaded-to)-body.*");
    ...
    public AndroidDigiOfficeDocumentUploadInfoIsNotEmptyNotNA() {
        super("AndroidDigiOfficeDocumentUploadInfoIsNotEmptyNotNA");
    }
        ...
        for (Widget w : state) {
            ...
            if (isInvalidValue(value)) {
                String verdictMsg = String.format(
                        "Detected document upload info with invalid content (resId=%s, value='%s') %s",
