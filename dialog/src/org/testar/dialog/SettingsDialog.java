...
public class SettingsDialog extends JFrame implements Observer {
   ...
   */
  private void start(TestarMode mode) {
    try {
  ...
  private void saveCurrentSettings() {
    ...
    try {
      ...
      Settings.setSettingsPath(settingsFile.substring(0, settingsFile.indexOf(TestarDirectories.SETTINGS_FILE) - 1));
  ...
  private void setLayout(JTabbedPane jTabsPane) {
    ...
    setTitle("TESTAR " + TestarInfo.VERSION);
